...
const VelarkoLogo = () => (
  <svg width="28" height="28" viewBox="0 0 350 350" xmlns="http://www.w3.org/2000/svg" aria-label="Velarko">
    <defs>
      <radialGradient id="bgGrad" cx="50%" cy="50%" r="80%">
        <stop offset="0%" stopColor="#ffd215" />
        <stop offset="100%" stopColor="#fff172" />
      </radialGradient>
      <filter id="blur28" x="-80%" y="-80%" width="260%" height="260%" colorInterpolationFilters="linearRGB"><feGaussianBlur stdDeviation="28"/></filter>
      <filter id="blur42" x="-80%" y="-80%" width="260%" height="260%" colorInterpolationFilters="linearRGB"><feGaussianBlur stdDeviation="42"/></filter>
      <filter id="blur49" x="-80%" y="-80%" width="260%" height="260%" colorInterpolationFilters="linearRGB"><feGaussianBlur stdDeviation="49"/></filter>
      <filter id="blur56" x="-80%" y="-80%" width="260%" height="260%" colorInterpolationFilters="linearRGB"><feGaussianBlur stdDeviation="56"/></filter>
      <clipPath id="v-clip">
    ...
    <g clipPath="url(#v-clip)">
      ...
      <circle cx="70" cy="70" r="70" fill="rgba(255,232,26,0.7)" filter="url(#blur28)" transform="translate(0,-127)" />
      <circle cx="70" cy="70" r="70" fill="rgba(255,163,26,0.7)" filter="url(#blur42)" transform="translate(236,25)" />
      <circle cx="70" cy="70" r="70" fill="#1a23ff" filter="url(#blur49)" transform="translate(-31,-38)" />
      <circle cx="70" cy="70" r="70" fill="#1a23ff" filter="url(#blur49)" transform="translate(205,-38)" />
      <circle cx="70" cy="70" r="70" fill="#e21bda" filter="url(#blur56)" transform="translate(31,-13)" />
      <circle cx="70" cy="70" r="70" fill="#e21bda" filter="url(#blur56)" transform="translate(144,51)" />
      <circle cx="70" cy="70" r="70" fill="rgba(255,163,26,0.7)" filter="url(#blur42)" transform="translate(21,89)" />
      <circle cx="70" cy="70" r="70" fill="rgba(255,163,26,0.7)" filter="url(#blur42)" transform="translate(72,-13)" />
      <circle cx="70" cy="70" r="70" fill="rgba(255,232,26,0.7)" filter="url(#blur28)" transform="translate(51,-38)" />
      <circle cx="70" cy="70" r="70" fill="rgba(255,232,26,0.7)" filter="url(#blur28)" transform="translate(164,51)" />
      <circle cx="70" cy="70" r="70" fill="rgba(255,163,26,0.7)" filter="url(#blur42)" transform="translate(10,13)" />
      <circle cx="70" cy="70" r="70" fill="rgba(255,163,26,0.7)" filter="url(#blur49)" transform="translate(134,13)" />
    </g>
  </svg>
);
  ...
  return (
    <div className="home-container" onClick={handleOutsideClick}>
        ...
        {section === "home" && (
          <div className="island-content island-home">
            ...
            <motion.button
              ...
              transition={bouncy}
            >
              <Plus size={22} strokeWidth={2.5} className="plus-spin" />
            </motion.button>
          </div>
        )}
        ...
        {section === "about" && (
          <div className="island-about">
            <h3 className="about-text">
              ...
              <br />
              Currently @{" "}
              <a href="https://velarko.com" target="_blank" rel="noopener noreferrer" aria-label="Velarko" className="velarko-logo-link">
                <VelarkoLogo />
              </a>
            </h3>
          </div>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 p-2.5 rounded-full text-[var(--foreground)] opacity-60 hover:opacity-100 hover:scale-110 active:scale-95 transition-all z-50 flex items-center justify-center cursor-pointer"
