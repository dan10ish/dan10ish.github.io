        ...
        <Section title="Current">
          <div className="space-y-1">
            {data.current.map((item, index) => (
              <p key={index} style={{ fontWeight: 'var(--right-font)', fontSize: 'var(--font-size)' }}>
                {item.title}
              </p>
            ))}
          </div>
        ...
        <Section title="Projects">
          <div className="space-y-2">
            {data.projects.map((project, index) => (
              <div key={index} className="flex items-center space-x-4 max-w-[450px]">
                <p className="flex-grow" style={{ fontWeight: 'var(--right-font)', fontSize: 'var(--font-size)' }}>{project.title}</p>
                {project.live ? (
                  <a
                    href={project.live}
                    target="_blank"
            ...
            {data.contact.map((item, index) => (
              <div key={index}>
                <a
                  ...
                  style={{ fontWeight: 'var(--right-font)', fontSize: 'var(--font-size)' }}
