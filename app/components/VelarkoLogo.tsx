...
export default function VelarkoLogo(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 350 350" xmlns="http://www.w3.org/2000/svg" {...props}>
      <defs>
        ...
        <filter id="blur28" x="-80%" y="-80%" width="260%" height="260%" colorInterpolationFilters="linearRGB">
          <feGaussianBlur stdDeviation="28" />
        </filter>
        <filter id="blur42" x="-80%" y="-80%" width="260%" height="260%" colorInterpolationFilters="linearRGB">
          <feGaussianBlur stdDeviation="42" />
        </filter>
        <filter id="blur49" x="-80%" y="-80%" width="260%" height="260%" colorInterpolationFilters="linearRGB">
          <feGaussianBlur stdDeviation="49" />
        </filter>
        <filter id="blur56" x="-80%" y="-80%" width="260%" height="260%" colorInterpolationFilters="linearRGB">
