  ...
  return (
    <div className="flex items-center mb-4">
      ...
      <div className="flex items-center gap-3">
        {sourceCode && (
          <Link href={sourceCode} target="_blank" className="flex items-center justify-center">
            <Github size={20} />
          </Link>
        )}
        {liveDemo && (
          <Link href={liveDemo} target="_blank" className="flex items-center justify-center">
            <Globe size={20} />
          </Link>
        )}
      </div>
