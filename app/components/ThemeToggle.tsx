...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className={`fixed bottom-5 right-5 w-5 h-5 rounded-full border-2 transition-all duration-100 hover:scale-110 hover:shadow-lg z-50 flex items-center justify-center ${
        theme === 'dark' 
