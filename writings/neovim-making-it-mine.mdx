...
Here is what it looks like in the [Ghostty](https://ghostty.org) terminal

![terminal](/writing-assets/Overall.png)

And here is how it looks like in Mac's default Terminal app.
