  ...
  return (
    <section className="about">
      <p>
        ...
        <Link href="/ml" prefetch={false} className="about-page-link">
          machine learning
        </Link>
        ,{" "}
        <Link href="/robotics" prefetch={false} className="about-page-link">
          robotics
        </Link>
        ,{" "}
        <Link href="/planes" prefetch={false} className="about-page-link">
          planes
        </Link>{" "}
        and{" "}
        <Link href="/finance" prefetch={false} className="about-page-link">
          finance
        </Link>
        . Connect via{" "}
        <a
